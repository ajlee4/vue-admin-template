<template>
	<div class="newslist-container">
		...
		<router-link to="/faq-question/create">
		...
		<div class="table-wrap">
			<el-table :data="data" border style="width: 100%" v-loading="listLoading">
				...
				<el-table-column align="right">
					<template slot-scope="scope">
						<router-link
							:to="{ name: 'faq-question-edit', params: { id: scope.row.id } }"
							class="edit-button"
						>
			...
			<Pagination
				...
				@pagination="getDataFaqListQuestion(listQuery.limit)"
			></Pagination>
		</div>
	</div>
</template>
...
import { fetchFaqQuestionList, deleteFaqQuestion } from '@/api/faq';
...
export default {
	...
	methods: {
		...
		getDataFaqListQuestion() {
			this.listLoading = true;
			fetchFaqQuestionList(this.listQuery).then((response) => {
