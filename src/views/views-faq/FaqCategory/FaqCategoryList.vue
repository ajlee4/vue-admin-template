<template>
  <div class="newslist-container">
    ...
    <router-link to="/faq-category/create">
    ...
    <div class="table-wrap">
      <el-table :data="data" border style="width: 100%" v-loading="listLoading">
        ...
        <el-table-column align="right">
          <template slot-scope="scope">
            <router-link
              :to="{ name: 'faq-category-edit', params: { id: scope.row.id } }"
              class="edit-button"
            >
      ...
      <Pagination
        ...
        @pagination="getDataFaqListCategory(listQuery.limit)"
      ></Pagination>
    </div>
  </div>
</template>
...
import { fetchFaqCategoryList, deleteFaqCategory } from "@/api/faq";
...
export default {
  ...
  methods: {
    ...
    getDataFaqListCategory() {
      this.listLoading = true;
      fetchFaqCategoryList(this.listQuery).then((response) => {
