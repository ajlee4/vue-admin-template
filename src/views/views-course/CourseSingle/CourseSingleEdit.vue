		...
		<el-tabs type="card">
							...
							><div class="grid-content ">
								<div class="block date-picker-wrapper">
									<el-form-item
										...
										:class="{
											'is-error':
												$v.data.end_date.$dirty &&
												!$v.data.end_date.required,
										}"
									>
										<el-date-picker
											class="date-picker"
          ...
          <el-row :gutter="20">
			...
			<el-tab-pane label="SEO">
				<el-form :label-position="labelPosition" label-width="100px" ref="seoForm">
					<el-row>
						<el-col :span="12">
...
export default {
	...
	methods: {
		...
		handleCourseEdit(id) {
			...
			this.data.start_recruit = this.$options.filters.parseTime(
				this.data.start_recruit,
				'{y}-{m}-{d}',
			);
			this.data.start_date = this.$options.filters.parseTime(
	...
	created() {
		this.$store.dispatch('getCurrentSingleCourse', this.$route.params.id).then(() => {
