<template>
	<div class="category-container">
			...
			<el-row :gutter="20" align="bottom" class="category-form-row">
				<el-col :span="6">
					<el-form-item
						...
						:class="{
							'is-error': $v.gradesName.$dirty && !$v.gradesName.required,
						}"
					>
						<el-input v-model="gradesName"></el-input>
						<small
							v-if="$v.gradesName.$dirty && !$v.gradesName.required"
							class="error-text"
		...
		<el-button type="success" @click="addTestGrades" class="add-category-button"
