	...
	<div>
        ...
        <el-dialog :visible.sync="dialogVisible">
          <img width="100%" :src="dialogImageUrl" alt="" />
			...
			<el-button type="success" class="succes-btn" @click="handleUpdateResourse(data.id)"
				>Изменить</el-button
			>
		</el-form>
	</div>
...
export default {
	...
	created() {
		this.$store.dispatch('getCurrentResourseLocalization', this.$route.params.id).then(() => {
