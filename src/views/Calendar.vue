		...
		>
			<template v-slot:formExtend="slotData">
				...
				<div>
					...
					<div
						v-if="
							slotData.formData.category_id == 4 || slotData.formData.category_id == 9
						"
					>
									...
									<div class="input_50 input_wrap">
										<div class="input_50">
											...
											<el-select
												...
												class="activate-form-valid-elem"
												:class="{
													invalid_fields: !scope.formData.from.hours,
												}"
											>
												<el-option
													v-for="item in hours"
									...
									<div class="input_50 input_wrap">
										<div class="input_50">
											...
											<el-select
												...
												@focus="showTooltip = false"
												:class="{
													invalid_fields: !scope.formData.to.hours,
												}"
											>
												<el-option
													v-for="item in hours"
										...
										<div class="input_50">
											...
											<el-select
												...
												@focus="showTooltip = false"
												:class="{
													invalid_fields: !scope.formData.to.minutes,
												}"
												:disabled="!interview_duration"
											>
												<el-option
...
import { editRecord, disableRecord, getCategoryRecords, deleteRecord } from '@/api/calendar';
