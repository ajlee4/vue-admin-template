<template>
	<el-form :label-position="labelPosition" label-width="100px">
		...
		<el-button type="success" class="succes-btn" @click="handleAddReviews">Создать</el-button>
	</el-form>
</template>

<script>
import { createWithoutExperience } from '@/api/withoutExperience';
...
export default {
	...
	methods: {
		...
		handleAddReviews() {
			...
			createWithoutExperience(this.data).then(() => {
