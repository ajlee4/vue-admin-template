<template>
	<router-link to="/" class="aside__logo">
		...
		>
			<g class="name">
				<path class="fill" d="M386.427,67.013h17.754v80.737h-17.754V67.013z"></path>
				<path
					class="fill"
...
C844.968,127.845,848.247,137.233,859.103,137.233z"
				...
				></path>
				<path class="fill" d="M1027.189,67.013h16.055v80.737h-16.055V67.013z"></path>
				<path
					class="fill"
			...
			<g class="ih">
				...
				></path>
				<rect x="136.479" y="119.037" fill="#FFFFFF" width="36.324" height="130.825"></rect>
				<path
					fill="#FFFFFF"
