...
//            }
      ...
      addFields: { // additional fields prop from parent
        type: Object,
        default(){
          return {}
        }
      },
      fieldsData: { //default field values
        type: Object,
        default(){return{}}
      }
    },
    ...
    watch: {
      fieldsData: function (val) { //set default field values
        this.formData = val
      }
    },
    methods:{
      submit(){
        ...
        if (this.$refs.inputValidate && Array.isArray(this.$refs.inputValidate)){ // validate inner inputs
        ...
        if (this.formValid){// emit submit to parent
          this.$emit('submit', this.formData)
        } else { // scroll to first invalid input
          this.showErr = true
