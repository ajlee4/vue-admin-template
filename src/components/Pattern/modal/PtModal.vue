				...
				<div class="modal_inner">
					<div class="modal_hdr">
						...
						<h3 v-if="data && data.length && !showFastEditModal">
							<br />
							{{ data[0].interview_time.slice(0, -3) }}
							{{ data[0].interview_date | moment('dd, DD, MMMM, YYYY') }}
					...
					<div v-if="showFastEditModal" class="row">
						<div class="row_wrapper row__item row__item-radio">
							<el-radio class="row__radio" v-model="radio" label="1"
								>Активировать</el-radio
							>
							<el-radio
							...
							<div>
								<div class="input_30 mb_20">
									<div class="custom_title">
										Ввести максимальное кол-во записей
									</div>
