	...
	['chunk-2f3296ae'],
	{
		...
		c231: function(e, t, r) {
			...
			var n = function() {
						...
						[
							...
							r(
								'el-button',
								{
									...
									on: {
										click: function(t) {
											return e.editTestGrades(e.data.id);
										},
									},
								},
								[e._v('Изменить уровень')],
							),
						],
						1,
					);
				...
				f = {
					...
					methods: {
						editTestGrades: function(e) {
							...
							Object(i['r'])(e, this.data).then(function() {
								Object(a['Message'])({
					...
					created: function() {
						var e = this;
						this.$store
							.dispatch('getTestGrades', this.$route.params.id)
							.then(function() {
								(e.listLoading = !1),
									(e.data = e.currentTestGrades),
									console.log(e.data);
							});
					},
					computed: {
						currentTestGrades: function() {
				...
				d = f,
				c = r('2877'),
				l = Object(c['a'])(d, n, u, !1, null, null, null);
			t['default'] = l.exports;
		},
		c301: function(e, t, r) {
			'use strict';
...
//# sourceMappingURL=chunk-2f3296ae.c1bdc618.js.map
