			...
			var a = function() {
												...
												scopedSlots: t._u([
													{
														key: 'default',
														fn: function(e) {
															return [t._v(t._s(e.row.grade.name))];
														},
													},
												]),
											}),
											n('el-table-column', {
												attrs: { label: 'Название Блока' },
												scopedSlots: t._u([
													{
														key: 'default',
														fn: function(e) {
															return [t._v(t._s(e.row.list.name))];
														},
													},
												]),
											}),
												...
												scopedSlots: t._u([
													{
														key: 'default',
														fn: function(e) {
															return [t._v(t._s(e.row.question))];
														},
													},
												]),
											}),
				...
				s = {
					...
					methods: {
						...
						getDataTestQuestion: function() {
							var t = this;
							(this.listLoading = !0),
								Object(r['p'])(this.listQuery).then(function(e) {
									(t.data = e.data.data),
...
//# sourceMappingURL=chunk-de41835e.7eeebf96.js.map
