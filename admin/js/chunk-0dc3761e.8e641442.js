		...
		fe5e: function(e, t, r) {
			...
			var n = function() {
				...
				f = {
					...
					validations: { data: { name: { required: l['required'] } } },
					data: function() {
						return {
							activeName: 'first',
							labelPosition: 'top',
					...
					methods: {
						handleCourseEdit: function(e) {
							if ((console.log(this.currentCourse), this.$v.$invalid))
								return (
									Object(i['Message'])({
							...
							Object(o['g'])(e, this.data).then(function() {
								Object(i['Message'])({
					...
					created: function() {
						var e = this;
						this.$store
							.dispatch('getCurrentCourse', this.$route.params.id)
							.then(function() {
								(e.listLoading = !1),
									(e.data = e.currentCourse),
									console.log(e.data);
							});
					},
					computed: {
...
//# sourceMappingURL=chunk-0dc3761e.8e641442.js.map
