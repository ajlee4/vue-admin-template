			...
			var n = function() {
						...
						[
							...
							r(
								'el-button',
								{
									...
									on: {
										click: function(t) {
											return e.handleUpdateResourse(e.data.id);
										},
									},
								},
								[e._v('Изменить')],
				...
				f = {
					...
					methods: {
						...
						handleUpdateResourse: function(e) {
							var t = this;
							if (this.$v.$invalid)
								return (
									Object(l['Message'])({
					...
					created: function() {
						...
						this.$store
							...
							.then(function() {
								(e.listLoading = !1),
									(e.data = e.currentResourse),
									console.log(e.data);
							});
					},
					computed: {
						currentResourse: function() {
...
//# sourceMappingURL=chunk-0d28e943.b53b9af3.js.map
