		...
		6203: function(e, t, r) {
			...
			var n = function() {
				...
				f = {
					...
					validations: { newsData: { page_title: { required: l['required'] } } },
					data: function() {
						return {
							activeName: 'first',
							labelPosition: 'top',
				...
				s = f,
				c = (r('e1d7'), r('2877')),
				d = Object(c['a'])(s, n, i, !1, null, '58f26c39', null);
			t['default'] = d.exports;
		},
		6235: function(e, t, r) {
			'use strict';
...
//# sourceMappingURL=chunk-00bf7fba.faa4e57d.js.map
