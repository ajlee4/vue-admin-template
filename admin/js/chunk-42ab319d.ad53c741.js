		...
		'1d64': function(e, t, r) {
			...
			var n = function() {
						...
						[
														...
														[
															r(
																...
																[
																	...
																	e.$v.data.page_title.$dirty &&
																	!e.$v.data.page_title.required
																		? r(
																				'small',
																				{
																					staticClass:
							...
							r(
								'el-button',
								{
									...
									on: {
										click: function(t) {
											return e.handleUpdateNews(e.data.id);
										},
									},
								},
								[e._v('Изменить')],
				...
				f = {
					...
					validations: { data: { page_title: { required: o['required'] } } },
					data: function() {
						return {
							data: [],
							activeName: 'first',
					...
					methods: {
						...
						handleUpdateNews: function(e) {
							...
							Object(i['e'])(e, this.data).then(function() {
								t.$message({
									type: 'success',
					...
					created: function() {
						var e = this;
						this.$store
							.dispatch('getCurrentNews', this.$route.params.id)
							.then(function() {
								(e.listLoading = !1), (e.data = e.currentNews), console.log(e.data);
							});
					},
					computed: {
				...
				c = f,
				d = (r('68a3'), r('2877')),
				s = Object(d['a'])(c, n, a, !1, null, null, null);
			t['default'] = s.exports;
		},
		'2a12': function(e, t, r) {
			'use strict';
...
//# sourceMappingURL=chunk-42ab319d.ad53c741.js.map
