		...
		c08b: function(t, e, n) {
			...
			var a = function() {
					...
					return n(
						...
						[
							n('h2', [t._v('Направления')]),
							n(
								'router-link',
								{ attrs: { to: '/subcourse/create' } },
								[
									n(
										'el-button',
										{
				...
				s = {
					...
					methods: {
						getDataCourse: function() {
							var t = this;
							(this.listLoading = !0),
								Object(o['o'])(this.listQuery).then(function(e) {
									(t.data = e.data.data),
				...
				l = s,
				c = (n('099d'), n('2877')),
				d = Object(c['a'])(l, a, i, !1, null, '17406d51', null);
			e['default'] = d.exports;
		},
		f372: function(t, e, n) {},
	},
]);
//# sourceMappingURL=chunk-e572a6d4.97c75895.js.map
